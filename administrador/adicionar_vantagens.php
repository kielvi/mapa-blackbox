		...
		<div class="container adicionar">
			<form id="form-adicionar" name="form-adicionar" method="post" action="" enctype="multipart/form-data">
				...
				<div class="col-md-4 form-group">
					<input type="file" id="input-file-now" name="arquivo" class="dropify" <?php echo ($row->foto<>'' ? "data-default-file='../$row->foto'" : ''); ?> data-max-file-size="2M" data-allowed-file-extensions="svg" />
				</div>
				...
				<div class="col-md-8 form-group">
					...
					<textarea class="form-control" id="texto" name="texto" rows="3"><?php echo $row->texto; ?></textarea>
				</div>
...
if(isset($acaoForm)) {
	...
	if($acaoForm=="adicionar") {
		mysql_query("INSERT INTO $nomeDaPagina (titulo, texto) VALUES ('$titulo', '$texto')");
	...
	if($acaoForm=="editar") { 
		...
		mysql_query("UPDATE $nomeDaPagina SET titulo='$titulo', texto='$texto' WHERE codigo='$codigo'");
	}
