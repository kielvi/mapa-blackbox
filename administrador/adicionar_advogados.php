		...
		<div class="container adicionar">
			<form id="form-adicionar" name="form-adicionar" method="post" action="" enctype="multipart/form-data">
				...
				<div class="col-md-3 form-group">
					...
					<input type="text" class="form-control" id="funcao" name="funcao" value="<?php echo $row->funcao; ?>" required>
				</div>
				<div class="col-md-7 form-group">
					<label for="texto">Biografia</label>
...
if(isset($acaoForm)) {
	...
	if($acaoForm=="adicionar") {
		mysql_query("INSERT INTO $nomeDaPagina (nome, funcao, texto) VALUES ('$nome', '$funcao', '$texto')");
	...
	if($acaoForm=="editar") { 
		...
		mysql_query("UPDATE $nomeDaPagina SET nome='$nome', funcao='$funcao', texto='$texto' WHERE codigo='$codigo'");
	}
