		...
		<div class="listagem-table">
			<?php if($totalItens>0) { 
				while($row = mysql_fetch_object($query)) {
					$empreendimento = mysql_fetch_object(mysql_query("SELECT titulo FROM empreendimentos WHERE codigo='$row->cod_empreendimento'")); ?>
					<article class="col-md-3 col-sm-4">
						<div class="listagem-item">
							...
							<p><strong><?php echo $App->SubStrTexto($empreendimento->titulo, 50); ?></strong></p>
							<p>Ordem: <?php echo $row->ordem; ?></p>
