...
if(isset($acaoForm)) {
	...
	if($acaoForm=="adicionar") {
		mysql_query("INSERT INTO $nomeDaPagina (ordem, empreendimento, lazer) VALUES ('$ordem', '$empreendimento', '$lazer')");		
	}
	// ALTERA UM REGISTRO NO BANCO
	if($acaoForm=="editar") { 
		// ALTERA OS DADOS NO BANCO DE DADOS
		mysql_query("UPDATE $nomeDaPagina SET ordem='$ordem', empreendimento='$empreendimento', lazer='$lazer' WHERE codigo='$codigo'");
	}
	...
	<div class="container-fluid">
		...
		<div class="container adicionar">
			<form id="form-adicionar" name="form-adicionar" method="post" action="" enctype="multipart/form-data">
				...
				<div class="col-md-4 form-group">
					<label for="lazer">Lazer e convivência</label>
					<input type="text" class="form-control" id="lazer" name="lazer" value="<?php echo $row->lazer; ?>" required>
				</div>
