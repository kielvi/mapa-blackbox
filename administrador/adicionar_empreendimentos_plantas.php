	...
	<div class="container-fluid">
		...
		<div class="col-md-12 mt-2">
			<div class="alert alert-warning" role="alert">
				...
				Tamanho: 839x790 pixels ou maior seguindo a mesma proporção
			</div>
		</div>
			...
			<form id="form-adicionar" name="form-adicionar" method="post" action="" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-7 form-group">
						...
						<input type="text" class="form-control" id="legenda" name="legenda" value="<?php echo $row->legenda; ?>" required>
					</div>
					<div class="col-md-7 form-group">
