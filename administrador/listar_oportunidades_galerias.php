		...
		<div class="listagem-table">
			<?php if($totalItens>0) { 
				while($row = mysql_fetch_object($query)) {
					$oportunidade = mysql_fetch_object(mysql_query("SELECT titulo FROM oportunidades WHERE codigo='$row->cod_oportunidade'")); ?>
					<article class="col-md-3 col-sm-4">
						<div class="listagem-item">
							...
							<p><b><?php echo $App->SubStrTexto($oportunidade->titulo, 50); ?></b></p>
