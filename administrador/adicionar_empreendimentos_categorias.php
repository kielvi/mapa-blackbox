...
if(isset($acaoForm)) {
	...
	if($acaoForm=="adicionar") {
		mysql_query("INSERT INTO $nomeDaPagina (ordem, categoria) VALUES ('$ordem', '$categoria')");		
	}
	// ALTERA UM REGISTRO NO BANCO
	if($acaoForm=="editar") { 
		// ALTERA OS DADOS NO BANCO DE DADOS
		mysql_query("UPDATE $nomeDaPagina SET ordem='$ordem', categoria='$categoria' WHERE codigo='$codigo'");
	}
