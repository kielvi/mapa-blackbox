	...
	<div class="container-fluid">
		...
		<div class="container adicionar">
			<form id="form-adicionar" name="form-adicionar" method="post" action="" enctype="multipart/form-data">
				...
				<div class="col-md-12 form-group <?php echo ($inputFoto==FALSE ? "hidden-xs-up" : ""); ?>">
...
if(isset($acaoForm)) {
	...
	if($acaoForm=="adicionar") {
		mysql_query("INSERT INTO $nomeDaPagina (titulo, texto, tipo) VALUES ('$titulo', '$texto', '$tipo')");
