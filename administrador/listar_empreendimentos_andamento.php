		...
		<div class="listagem-table">
			<?php if($totalItens>0) { 
				while($row = mysql_fetch_object($query)) {
					$empreendimento = mysql_fetch_object(mysql_query("SELECT * FROM empreendimentos WHERE codigo='$row->cod_empreendimento'")); ?>
					<article class="col-md-3 col-sm-4">
						<div class="listagem-item text-center">
							...
							<h1><?php echo $App->SubStrTexto($empreendimento->titulo, 50); ?></h1>
							<p class="text-danger"><strong>CONCLUÍDO: <?php echo $row->concluido; ?>%</strong></p>
