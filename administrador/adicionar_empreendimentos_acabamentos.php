...
if(isset($acaoForm)) {
	...
	if($acaoForm=="adicionar") {
		mysql_query("INSERT INTO $nomeDaPagina (ordem, empreendimento, acabamento) VALUES ('$ordem', '$empreendimento', '$acabamento')");		
	}
	// ALTERA UM REGISTRO NO BANCO
	if($acaoForm=="editar") { 
		// ALTERA OS DADOS NO BANCO DE DADOS
		mysql_query("UPDATE $nomeDaPagina SET ordem='$ordem', empreendimento='$empreendimento', acabamento='$acabamento' WHERE codigo='$codigo'");
	}
		...
		<div class="container adicionar">
			<form id="form-adicionar" name="form-adicionar" method="post" action="" enctype="multipart/form-data">
				...
				<div class="col-md-4 form-group">
					...
					<input type="text" class="form-control" id="acabamento" name="acabamento" value="<?php echo $row->acabamento; ?>" required>
				</div>
