...
$p = $p+0;
$in = $p*$max;
$total = @mysql_num_rows(mysql_query("SELECT * FROM {$nomeDaPagina} WHERE 1=1 ".($buscar<>'' ? " AND (titulo LIKE '%$buscar%' OR endereco LIKE '%$buscar%')" : "")." ORDER BY codigo DESC"));
				...
				while($row = mysql_fetch_object($query)) {
					...
					<article class="col-md-3 col-sm-4">
						<div class="listagem-item">
							...
							<p><?php echo ($row->valor!=''?"R$ ":false).$row->valor; ?></p>
